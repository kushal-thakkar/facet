...
async def update_exploration(
    ...
    try:
        ...
        updated_exploration = Exploration(
            id=exploration_id,
            name=exploration_update.name if exploration_update.name is not None else existing_exploration.name,
            description=exploration_update.description if exploration_update.description is not None else existing_exploration.description,
            query=exploration_update.query if exploration_update.query is not None else existing_exploration.query,
