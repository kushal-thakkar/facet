    ...
    try {
      ...
      try {
        ...
        if (errorMessage.includes('API Error:')) {
          errorMessage = errorMessage.replace('API Error:', 'Connection Error:');
        }

        // Add a generic helpful message
        errorMessage +=
          '\n\nPlease verify your connection settings and ensure they are correct for your ' +
