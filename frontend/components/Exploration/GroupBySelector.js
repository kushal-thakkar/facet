        ...
        <div className="fixed inset-0 z-10 overflow-y-auto" aria-labelledby="group-by-dialog-title">
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
              <div>
                <h3 className="text-lg leading-6 font-medium text-gray-900" id="group-by-dialog-title">
                ...
                <div className="mt-4">
                  ...
                  >
                    ...
                    {availableDimensions.map(dimension => (
                      ...
                      >
                        {dimension.name} {groupBy.includes(dimension.id) ? '(already selected)' : ''}
                      </option>
                    ))}
                  </select>
                  
                  {/* Date dimensions might need additional options for grouping */}
                  {selectedDimension && availableDimensions.find(
